...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        scaffoldBackgroundColor: const Color.fromARGB(255, 255, 255,
            255), // Definindo o fundo preto para todo o aplicativo
      ),
    );
  }
}
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          ...
          style: TextStyle(
              color:
                  Color.fromARGB(255, 255, 255, 255)), // Definir a cor do texto
        ),
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        iconTheme: IconThemeData(
            color: Colors.white), // Definir a cor do ícone de compartilhamento
        actions: [
          IconButton(
